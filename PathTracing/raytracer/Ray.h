...
{
public:
	Ray(Point3 origin=Point3(0,0,0),Vec3 direction=Vec3(0,0,0),SOURCE source=SOURCE::NONE)
		:origin(origin),direction(Normalize(direction)),source(source),tMin(EPS),tMax(DOUBLE_POSITIVE_INFINITY){inverseDirection=1.0/this->direction;};
